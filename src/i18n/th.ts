export default {
  ...
  'settings.demo.desc': 'โหมดนี้จะแสดงรายการธุรกรรมจำลองกว่า 60 รายการตั้งแต่เดือนมกราคม 2021 ถึงพฤษภาคม 2026 เหมาะสำหรับการทดสอบฟีเจอร์ กราฟวิเคราะห์ และระบบพยากรณ์โดยไม่ต้องเชื่อมต่อข้อมูลจริง',
