            ...
            <div className="flex items-center gap-2 shrink max-w-[50%] md:max-w-none justify-end min-w-0">
              ...
              <div className="hidden md:flex flex-row items-center gap-3 w-full">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-xl bg-slate-900 dark:bg-white px-3 py-2 text-xs font-bold text-white dark:text-slate-900 hover:bg-slate-800 dark:hover:bg-slate-200 transition-colors shadow-sm shrink-0"
                >
                  <Settings className="h-4 w-4" />
                  <span>Data</span>
                </button>
