      ...
      <div className="relative w-full max-w-xl rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl overflow-hidden z-10 animate-in fade-in zoom-in duration-200">
        ...
        <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 px-6 py-4">
          <div>
            ...
            <p className="text-xs text-slate-400 dark:text-slate-400">Manage storage locations and internal transfers</p>
          </div>
          <button
            onClick={onClose}
          ...
          <button
            ...
            className={`flex-1 py-3 text-xs font-bold transition-all border-b-2 ${
              activeTab === 'transfer' 
                ...
                : 'border-transparent text-slate-400 dark:text-slate-400 hover:text-slate-600 dark:text-slate-300'
            }`}
          >
            Log Transfer
          </button>
            ...
            <div className="space-y-6">
              <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 p-5 space-y-4">
                <div className="flex flex-col sm:grid sm:grid-cols-[1fr_auto_1fr] items-start sm:items-end gap-3">
                  <div className="space-y-1.5 w-full">
                    ...
                    <select
                      ...
                      className="w-full rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-3 py-2 text-sm text-slate-900 dark:text-white focus:border-emerald-500 focus:outline-none"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-3 py-2 text-sm text-slate-900 dark:text-white focus:border-emerald-500 focus:outline-none [color-scheme:dark]"
                    />
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full rounded-lg bg-emerald-500 py-2.5 text-sm font-bold text-slate-950 transition-colors hover:bg-emerald-400 disabled:opacity-50 disabled:hover:bg-emerald-500 dark:disabled:hover:bg-emerald-500"
                >
